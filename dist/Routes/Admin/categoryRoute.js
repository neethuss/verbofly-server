...
router.post('/addCategory', authenticationMiddleware_1.default, (req, res) => categoryController.postCreateCategory(req, res));
router.get('/categories', authenticationMiddleware_1.default, (req, res) => categoryController.getCategories(req, res));
router.get('/:id', authenticationMiddleware_1.default, (req, res) => categoryController.getCategory(req, res));
router.patch('/:id', authenticationMiddleware_1.default, (req, res) => categoryController.updateCategory(req, res));
router.get('/categories', authenticationMiddleware_1.default, (req, res) => categoryController.getCategories(req, res));
