...
class ProgressController {
    ...
    updateOrCreateProgress(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const progress = yield this.progressService.updateOrCreateProgress(new mongoose_1.Types.ObjectId(userId), new mongoose_1.Types.ObjectId(languageId), lessonId ? new mongoose_1.Types.ObjectId(lessonId) : null, isCompleted !== null && isCompleted !== void 0 ? isCompleted : false, result);
