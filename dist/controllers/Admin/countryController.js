        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (existingCountry) {
                    ...
                    const newCountry = yield this.countryService.createCountry(countryname);
    ...
    updateCountry(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const existingCountry = yield this.countryService.findByCountryName(name);
                if (existingCountry && existingCountry._id != id) {
                    res.status(409).json({ message: "Country already exists with this name" });
                    return;
                }
                const updatedCountry = yield this.countryService.updateCountry(id, { countryName: name });
