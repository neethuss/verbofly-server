    ...
    postCreateLesson(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const existingLesson = yield this.lessonService.findByTitle(title);
    ...
    editLessonById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const existingLesson = yield this.lessonService.findByTitle(lessonBody.title.toLocaleLowerCase());
                if (existingLesson && existingLesson._id != lessonId) {
                    res.status(409).json({ message: "Language already exists with this name" });
                    return;
                }
                const updatedLessonData = Object.assign(Object.assign({}, lessonBody), { title: lessonBody.title.toLowerCase() });
                const updatedLesson = yield this.lessonService.updateLesson(lessonId, updatedLessonData);
