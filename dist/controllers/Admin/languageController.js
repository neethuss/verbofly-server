    ...
    postLanguage(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.log(language, 'skg');
                const existingLanguage = yield this.languageServie.findByLanguageName(language.languageName);
                if (existingLanguage) {
    ...
    updateLanguage(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const updatedLanguage = yield this.languageServie.updateLanguagae(id, { languageName, countries });
                if (!updatedLanguage) {
